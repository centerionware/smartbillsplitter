...
__export(payment_exports, {
  cancelSubscriptionHandler: () => cancelSubscriptionHandler2,
  createCheckoutSessionHandler: () => createCheckoutSessionHandler3,
  getPayPalSubscriptionDetailsHandler: () => getPayPalSubscriptionDetailsHandler,
  manageSubscriptionHandler: () => manageSubscriptionHandler3,
  updateCustomerMetadataHandler: () => updateCustomerMetadataHandler2,
  verifyPaymentHandler: () => verifyPaymentHandler3
});
...
0 && (module.exports = {
  ...
  getPayPalSubscriptionDetailsHandler,
  manageSubscriptionHandler,
  updateCustomerMetadataHandler,
