...
const ParticipantCard: React.FC<ParticipantCardProps> = ({ name, totalOwed, onClick, onShare }) => {
  return (
    <div
      onClick={onClick}
      ...
      <div className="flex justify-between items-start">
        ...
        <div className="flex items-center gap-2">
            <button
                ...
                title="Share reminder with participant"
                ...
                aria-label={`Share reminder with ${name}`}
            >
