...
export const getSubscriptionDetailsHandler = async (req: HttpRequest): Promise<HttpResponse> => {
    try {
        ...
        let plan: PayPalSubscriptionDetails['plan'] = 'unknown';
        ...
        const details: PayPalSubscriptionDetails = {
            ...
            isCurrentDevice: false, // This will be set on the client
        };
